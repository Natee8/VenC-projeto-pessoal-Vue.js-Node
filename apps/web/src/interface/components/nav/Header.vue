...
<template>
  <header
    class="fixed top-0 left-0 w-full bg-headerColor/60 backdrop-blur-sm border-b border-borderDefault z-50"
  >
    <div class="w-full mx-auto px-16 h-20 flex items-center justify-between">
